...
def main(args):
    ...
    dense_flag = args.opt in ('2d_dense', '3d', 'depth', 'pncc', 'uv_tex', 'ply', 'obj', 'filter')
    ...
    if args.opt == '2d_sparse':
        ...
        uv_tex(img, ver_lst, tddfa.tri, show_flag=args.show_flag, uv_h=512, uv_w=512, wfp=wfp)
    elif args.opt == 'pose':
        ...
        img_draw = render_filter(img, ver_lst, tddfa.tri, filter=list_filters[1], alpha=0.7)
        cv2.imwrite('res_fil.jpg',img_draw*255)
...
if __name__ == '__main__':
    ...
    parser.add_argument('-o', '--opt', type=str, default='uv_tex',
                        choices=['2d_sparse', '2d_dense', '3d', 'depth', 'pncc', 'uv_tex', 'pose', 'ply', 'obj', 'filter'])
